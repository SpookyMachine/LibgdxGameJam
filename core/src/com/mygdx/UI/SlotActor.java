...
import com.mygdx.entities.Slot;
import com.mygdx.entities.SlotListener;
...
//        addListener(new TooltipListener(tooltip, true));
    ...
    private static ImageButtonStyle createStyle(Skin skin, Slot slot) {
        TextureAtlas icons = InventoryScreen.assets.get("icons/icons.atlas", TextureAtlas.class);
        TextureRegion image;
